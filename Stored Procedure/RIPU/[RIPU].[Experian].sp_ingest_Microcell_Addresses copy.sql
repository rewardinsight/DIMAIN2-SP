USE [RIPU]
GO
/****** Object:  StoredProcedure [Experian].[sp_ingest_Microcell_Addresses]    Script Date: 8/18/2026 5:20:09 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER procedure [Experian].[sp_ingest_Microcell_Addresses] as

DECLARE @code varchar(1000)
SET @code = 'python "C:\SSIS\ExperianRIPUPipeline\microcell_addresses_sftp_to_dimain.py"'
