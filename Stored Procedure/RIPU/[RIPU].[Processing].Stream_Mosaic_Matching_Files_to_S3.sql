USE [RIPU]
GO
/****** Object:  StoredProcedure [Processing].[Stream_Mosaic_Matching_Files_to_S3]    Script Date: 19/08/2026 10:13:57 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [Processing].[Stream_Mosaic_Matching_Files_to_S3]
(
...
BEGIN
    ...
    SET @sql = 'python "E:\DataOpsFunctions\RIRUPipelne\reward-dataops-dimain-s3-stream-mosaic\run_export_mosaic.py"'
